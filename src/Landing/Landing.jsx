...
const Landing = () => {
    ...
    return (
        <div className='pt-24 w-full flex flex-col justify-center items-center'>
            ...
            <h1 className='text-7xl font-extrabold bg-text-gradient bg-clip-text text-transparent'>Welcome to Bard</h1>
            <h2 className='text-[#b3b3b3] mt-2 mb-4 text-lg'>The #1 confluence, wallet, and criteria-based signal bot on Solana</h2>
            <JoinButton />
            <div className='w-[60%] flex flex-row flex-wrap justify-evenly mt-16'>
